...
## v1.1.3
- 美化：大幅重构主页“今日天气”模块，加入湿度、降水概率及体感温度等多维数据，并支持基于实时天气与昼夜变化的 SVG 动态天气图标与智能穿衣建议。
- 美化：修改应用打包图标为黑底圆角及 12 色渐变的张力艺术化 `LI` 图标，并在浏览器内通过强刷策略修复 favicon 缓存问题。
- 美化：启动副标题统一修改为 "LI氏专属定制版"，并将天气服务的默认保底城市统一重构为“深圳”。
## v1.1.2
